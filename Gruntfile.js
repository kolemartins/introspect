// Generated on 2016-05-01 using generator-angular-fullstack 3.6.1
'use strict';
  ...
  grunt.initConfig({
    ...
    copy: {
      dist: {
        ...
        }, {  // adding to copy ui-grid glyphs to dist package - w/o this the grid glyphs showed in korean
          expand: true,
          cwd: '<%= yeoman.client %>/bower_components/angular-ui-grid',
